...
export default function CV() {
  return (
    <main class="text-center mx-auto min-h-screen z-20 overflow-x-hidden pt-20">
          ...
          <div class="overflow-x-hidden mt-10 p-4 bg-neutral md:rounded-box">
            <div class="max-w-full space-y-4 text-left">
              <p class="text-lg md:text-xl">
                I am a dedicated and skilled software developer from Denmark, who recently graduated
                ZBC Slagelse. With a passion for programming and experience in various projects, I
                have developed a strong foundation in software development.
              </p>
              <p class="text-lg md:text-xl">
                <strong>Education:</strong> ZBC Slagelse - Robot Technology, 2021 - 2024 (Grade
                Average: 9.9/12.0)
              </p>
              <p class="text-lg md:text-xl">
                <strong>Experience:</strong> Software Developer at ZBC Ringsted Confectionary
                Department, Jan 2024 - Jun 2024
              </p>
              <p class="text-lg md:text-xl">
                <strong>Skills:</strong> Rust, C#, Python, HTML, CSS, Javascript/Typescript, Svelte,
                Tailwind CSS, Node & Bun, NextJS, SolidJS, and Docker
              </p>
              <p class="text-lg md:text-xl">
              ...
              <div class="dropdown dropdown-top">
                <div tabindex="0" role="button" class="btn btn-outline">
                  ...
                  <svg
                    ...
                    version="1.1"
                    id="Layer_1"
                    viewBox="-31.82 -31.82 381.83 381.83"
                    stroke="#000000"
                  >
                    ...
                    <g
                      ...
                      stroke="#CCCCCC"
                      stroke-width="7.636511999999999"
                    ></g>
                ...
                >
                  <li>
                    <button
                      onClick={() =>
                        window.open(
                          "https://cdn.sfsteffensen.dev/CV%26Resume/Sebastian-Steffensen-CV-EN.pdf",
                        )
                      }
                    >
                      English CV
                  ...
                  <li>
                    <button
                      onClick={() =>
                        window.open(
                          "https://cdn.sfsteffensen.dev/CV%26Resume/Sebastian-Steffensen-CV-DA.pdf",
                        )
                      }
                    >
                      Danish CV
